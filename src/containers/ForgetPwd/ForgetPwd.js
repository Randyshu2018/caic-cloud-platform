...
class Forgetpwd extends React.Component {
  ...
  static SECOND = 60;
  state = {
    codeText: Forgetpwd.CODE_TEXT,
  };
  componentDidMount() {}

  userService = new UserService();
  time = Forgetpwd.SECOND;
                ...
                <Col span={16}>
                  {getFieldDecorator('code', {
                    rules: [
                      ...
                      {
                        max: Forgetpwd.CODE_LENGTH,
                        message: `验证码的长度为${Forgetpwd.CODE_LENGTH}`,
                      },
                      {
                        min: Forgetpwd.CODE_LENGTH,
                        message: `验证码的长度为${Forgetpwd.CODE_LENGTH}`,
                      },
                    ],
                  })(
