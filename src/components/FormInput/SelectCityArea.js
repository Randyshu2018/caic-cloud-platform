...
export default class SelectCityArea extends React.Component {
  static propTypes = {
    initAreaValue: PropTypes.array,
  };
  ...
  render() {
    const { initAreaValue } = this.props;
    return (
      <div className="form-input-container">
        <Cascader
          defaultValue={initAreaValue}
          options={options}
...
const options = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        value: '随州市',
        label: '随州市',
        children: [{ value: '曾都区', label: '曾都区' }, { value: '广水市', label: '广水市' }],
      },
      {
        value: '恩施土家族苗族自治州',
        label: '恩施土家族苗族自治州',
  ...
  },
  {
    ...
    children: [
      ...
      { value: '东莞市', label: '东莞市', children: [{ value: '市辖区', label: '市辖区' }] },
      { value: '中山市', label: '中山市', children: [{ value: '市辖区', label: '市辖区' }] },
      {
        value: '潮州市',
        label: '潮州市',
        children: [
  ...
  },
  {
    ...
    label: '台湾',
    children: [
      { value: '台北', label: '台北', children: [] },
      { value: '高雄', label: '高雄', children: [] },
      { value: '基隆', label: '基隆', children: [] },
      { value: '台中', label: '台中', children: [] },
      { value: '台南', label: '台南', children: [] },
      { value: '新竹', label: '新竹', children: [] },
      { value: '嘉义', label: '嘉义', children: [] },
      { value: '宜兰', label: '宜兰', children: [] },
      { value: '桃园', label: '桃园', children: [] },
      { value: '苗栗', label: '苗栗', children: [] },
      { value: '彰化', label: '彰化', children: [] },
      { value: '南投', label: '南投', children: [] },
      { value: '云林', label: '云林', children: [] },
      { value: '屏东', label: '屏东', children: [] },
      { value: '台东', label: '台东', children: [] },
      { value: '花莲', label: '花莲', children: [] },
      { value: '澎湖', label: '澎湖', children: [] },
    ],
  },
  {
    value: '香港',
  ...
  },
  {
    ...
    label: '澳门',
    children: [
      { value: '澳门半岛', label: '澳门半岛', children: [] },
      { value: '氹仔岛', label: '氹仔岛', children: [] },
      { value: '路环岛', label: '路环岛', children: [] },
      { value: '路氹城', label: '路氹城', children: [] },
    ],
  },
];
